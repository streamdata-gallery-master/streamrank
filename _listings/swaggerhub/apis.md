...
description: 'The place for teams to collaborate and coordinate the entire workflow
  ...
  lets you write, visualize and validate all at the same time.  '
...
created: "2018-06-03"
modified: "2018-06-03"
url: https://raw.githubusercontent.com/streamdata-gallery-master/streamrank/master/_listings/swaggerhub/apis.yaml
specificationVersion: "0.14"
apis:
- name: Swagger Hub Registry
  description: The place for teams to collaborate and coordinate the entire workflow
    of an APIs lifecycle
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/SwaggerHub_Logo_Horizontal_Color.png
  humanURL: ""
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-master/streamrank/master/_listings/swaggerhub/apis-owner-api-version-comment-get.md
x-common:
- type: x-github
