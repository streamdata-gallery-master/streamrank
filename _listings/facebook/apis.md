...
- name: Facebook
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-master/streamrank/master/_listings/facebook/videolikes-get-openapi.md
x-common:
- type: x-android-sdk
...
- type: x-webhook
  url: https://developers.facebook.com/docs/messenger-platform/webhook/
- type: x-website
  url: http:///business
- type: x-website
